            ...
            <CardBody>
                ...
                <Row>
                    ...
                    <FormGroup>
                        ...
                        {videoCheckBox?<Input size="sm" id="blogVideo" onChange={(event)=>{setVideoFile(event.target.files[0])}} type="file" placeholder="Blog Video"></Input>:<Input size="sm" id="blogVideo" type="file" disabled></Input>}
                    </FormGroup>
                    </Col>
                    <Col>
                    <FormGroup>
